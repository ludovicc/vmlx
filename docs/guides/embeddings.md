...
vmlx-engine supports text embeddings using [mlx-embeddings](https://github.com/Blaizzy/mlx-embeddings), providing an OpenAI-compatible `/v1/embeddings` endpoint.
...
vmlx-engine serve my-llm-model --embedding-model mlx-community/all-MiniLM-L6-v2-4bit
```
