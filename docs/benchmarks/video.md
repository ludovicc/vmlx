...
vmlx-engine-bench --model mlx-community/Qwen3-VL-8B-Instruct-4bit --video --quick

# Custom video
vmlx-engine-bench --model mlx-community/Qwen3-VL-8B-Instruct-4bit --video --video-url https://example.com/video.mp4
```
